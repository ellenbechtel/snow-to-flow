...
export default {
    name: "LineChart", 
    data() {  // code adapted from https://codesandbox.io/s/7y300q234j?file=/src/components/linechart.vue:2674-4971
      return {
        ...
        //Translate co-ords for chart, x axis and yaxis. This is injected into template // Ellen's not sure about this part
    ...
    //   this.chartWidth = window.innerWidth - this.chartMargin.left - this.chartMargin.right;
    //   this.chartHeight = window.innerHeight *0.25 - this.chartMargin.top - this.chartMargin.bottom;

    //   // begin drawing script when window loads
    //   this.drawSWEChart();
